            ...
            <div class="space-y-6">
                ...
                <div class="info-badge rounded-xl p-6">
                    <div class="flex items-center mb-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="info-badge rounded-xl p-6">
                        ...
                        <p class="text-2xl font-bold text-gray-800">Rp
                            {{ number_format($stock->product->price ?? 0, 0, ',', '.') }}</p>
                    </div>
                ...
                <!-- time -->
                <div class="info-badge rounded-xl p-6">
                    <p class="text-sm font-semibold text-gray-500 mb-2">Waktu Stok <span class="px-3 py-1 rounded-full text-xs {{ $stock->type === 'in' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">{{ $stock->type === 'in' ? 'Masuk' : 'Keluar' }}</span></p>
