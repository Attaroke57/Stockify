    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="glass-card rounded-3xl shadow-2xl p-6 mb-6 fade-in">
            <form method="GET" class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('reports.stock.export', request()->query()) }}" class="px-6 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="table-row">
                            ...
                            <td class="px-6 py-4 text-right">
                                <span class="px-3 py-1 {{ $p->stock > 10 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }} rounded-lg text-sm font-bold">
                                    {{ $p->stock ?? 0 }}
                                </span>
                            </td>
                        </tr>
