...
<div class="mx-auto max-w-3xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 fade-in">
        <div class="flex items-center text-sm text-purple-100 mb-3">
            ...
            <span class="text-white font-semibold">Tambah Supplier Baru</span>
        </div>
        <h1 class="text-4xl font-bold text-white mb-2">Tambah Supplier Baru</h1>
        <p class="text-purple-100">Lengkapi formulir untuk menambahkan supplier 🏢</p>
    </div>
    ...
    <div class="mt-6 glass-card rounded-2xl shadow-xl p-6 fade-in">
        <div class="flex items-start">
            ...
            <div>
                <h3 class="font-bold text-gray-800 mb-2">💡 Tips Menambahkan Supplier</h3>
                <ul class="text-sm text-gray-600 space-y-1">
                    <li>• Pastikan nama supplier sudah benar dan lengkap</li>
                    <li>• Informasi kontak sangat penting untuk komunikasi</li>
                    <li>• Alamat lengkap memudahkan pengiriman barang</li>
                </ul>
            </div>
        </div>
    </div>
