<x-layout title="Tambah Produk">
    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        @if (session('success'))
            <div
                class="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 rounded-xl shadow-lg fade-in">
        ...
        @if (session('general'))
            <div
                class="mb-6 p-4 bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-yellow-500 rounded-xl shadow-lg fade-in">
                <div class="flex items-center">
        ...
        @if ($errors->any())
            <div
                class="mb-6 p-4 bg-gradient-to-r from-red-50 to-rose-50 border-l-4 border-red-500 rounded-xl shadow-lg fade-in">
                <div class="flex items-start">
                    <svg class="w-6 h-6 text-red-500 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
            class="glass-card rounded-3xl shadow-2xl p-8 fade-in">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input name="selling_price" value="{{ old('selling_price', '') }}" type="text"
                                inputmode="decimal"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-xs mt-2">Jelaskan detail produk, spesifikasi, atau informasi
                            penting lainnya</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-6 glass-card rounded-2xl shadow-xl p-6 fade-in">
            <div class="flex items-start">
                <div
                    class="w-10 h-10 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
